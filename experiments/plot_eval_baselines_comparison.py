...
# ============================================================
NPZ_FILES = {
    "DDPP": "results/results_baselines/ddpp/DDPP_eval_lambda_0.0.npz",
    "MaxSNR": "results/results_baselines/maxsnr/MaxSNR_eval_lambda_0.0.npz",
    "PF-HAPPO": "results/results_baselines/pf/ConstrainedHAPPO_pf_eval_hard_kappa_0.03_use_dimensionless.npz",
    "Jensen-HAPPO": "results/results_baselines/jensen/ConstrainedHAPPO_jensen_eval_hard_kappa_0.03_use_dimensionless.npz",
    "HeLyMARL": "results/results_mappo_happo/HeLyMARL_eval_hard_kappa_0.03.npz",
}
